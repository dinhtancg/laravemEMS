            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li class="active {(Route::current() == 'amdin/articles')? 'active' : '' }}"><a href="{{ route('admin.article.index') }}"><i class="fa fa-circle-o"></i> All Articles</a></li>
              ...
              {{--<span class="label label-primary pull-right">4</span>--}}
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Thể Thao</a></li>
                            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>Thế Giới</a></li>
                            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i>Du Lịch</a></li>
                            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>Văn Hóa</a></li>
                            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>Xã Hội</a></li>
                        </ul>
                    </li>
                    <li>
